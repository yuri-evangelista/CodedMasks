...
### <a id='write_mask_fits'></a> `write_mask_fits(fitsfile, mask, rmatrix, bulk, props, props0)`
...
* `props0` (`dict`): A dictionary containing properties to be written into the FITS primary header, such as 'AREA', 'MDDIST', 'NANODES'.
